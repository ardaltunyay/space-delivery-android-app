...
val useCaseModule = module {
    single { SpaceVehicleUseCase(spaceVehicleRepository = get(), spaceStationUseCase = get(), currentPropertiesRepository = get()) }
    single { SpaceStationUseCase(spaceStationRepository = get()) }
}